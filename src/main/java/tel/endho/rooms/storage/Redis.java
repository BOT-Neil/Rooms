        ...
        pubSubAsyncCommands.getStatefulConnection().addListener(new RedisPubSubListener<>() {
          ...
          public void message(String channel, String message) {
            if (channel.equals("Rooms" + bungeesrvname)) {
              ...
              try {
                // Rooms.debug("bytearry "+byteArray.readUTF());
                ...
                if (tag.equals("global_update")) {
                  ...
                  GlobalRoomWorlds.getGlobalRoomWorlds().put(worlduuid,
                      new GlobalRoomWorld(worlduuid, ownername, lastserver, systime));
                  // GlobalRoomWorlds.putRoom(worlduuid, new GlobalRoomWorld(worlduuid, ownername,
                  // lastserver, systime));
                }
